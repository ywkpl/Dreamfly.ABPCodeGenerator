...
namespace Dreamfly.JavaEstateCodeGenerator.Migrations
{
    ...
    [Migration("20210312025217_AddStringTypeLengthAndEntityItemAddRelate1")]
    partial class AddStringTypeLengthAndEntityItemAddRelate1
    {
            ...
            modelBuilder.Entity("Dreamfly.JavaEstateCodeGenerator.SqliteDbModels.EntityItem", b =>
                {
                    ...
                    b.Property<bool>("NeedForeignKey")
                        .HasColumnType("INTEGER");

                    b.Property<string>("RelateEntityName")
                        .HasMaxLength(50)
                        .HasColumnType("TEXT");
